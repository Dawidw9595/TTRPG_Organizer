...
public class rejestracjauzyt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(rejestracjauzyt.this, "Wszystkie pola są wymagane",Toast.LENGTH_LONG).show();
        ...
        userdb myDB = new userdb(rejestracjauzyt.this);
        ...
        rejestracja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(rejestracjauzyt.this, "Nie uzupełniono któregoś z pól",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    if(5>nick.getText().toString().length() || 15<nick.getText().toString().length())
                    {
                        Toast.makeText(rejestracjauzyt.this, "Login powinien zawierać od 5 do 15 znaków ",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        if (1 == myDB.login(nick.getText().toString().trim()))
                        {
                            Toast.makeText(rejestracjauzyt.this, "Podany Login jest już zajęty",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            if(haslo1.getText().toString().equals(haslo2.getText().toString()))
                            {
                                ...
                                {
                                    Toast.makeText(rejestracjauzyt.this, "Hasło powinno zawierać przynajmniej 5 znaków",Toast.LENGTH_SHORT).show();
                                }
                                else
                                {
                                    ...
                                    {
                                        Toast.makeText(rejestracjauzyt.this, "Imię nie może zawierać cyfr",Toast.LENGTH_SHORT).show();
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            Toast.makeText(rejestracjauzyt.this, "Nazwisko nie może zawierać cyfr",Toast.LENGTH_SHORT).show();
                                        }
                                        else
                                        {
                                            ...
                                            {
                                                Toast.makeText(rejestracjauzyt.this, "Podany e-mail jest niepoprawny",Toast.LENGTH_SHORT).show();
                                            }
                                            else
                                            {
                                                if(1 == myDB.mail(email.getText().toString().trim()))
                                                {
                                                    Toast.makeText(rejestracjauzyt.this, "Użytkownik o takim adresie e-mail już istnieje",Toast.LENGTH_SHORT).show();
                                                }
                                                else
                                                {
                                                    ...
                                                    Intent intent=new Intent(rejestracjauzyt.this,MainActivity.class);
                            ...
                            {
                                Toast.makeText(rejestracjauzyt.this, "Podane hasła są różne",Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                }
