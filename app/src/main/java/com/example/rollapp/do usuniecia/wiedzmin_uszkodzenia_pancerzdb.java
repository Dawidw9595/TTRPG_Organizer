...
public class wiedzmin_uszkodzenia_pancerzdb extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "TTRPG";
    private static final int DATABASE_VERSION = 14;

    private static final String TABLE_NAME = "wiedzmin_uszkodzenia_pancerza";
    ...
    private static final String COLUMN_R_LEG = "p_noga";





    public wiedzmin_uszkodzenia_pancerzdb(@Nullable Context context) {
