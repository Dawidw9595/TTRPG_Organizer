...
public interface kartaApi {
    ...
    @POST("/karta/updatewyglad")
    Call<Void> updatewyglad(@Body wiedzmin_karta wiedzmin_karta);

    @POST ("/karta/updatecharakter")
    Call<Void> updatecharakter(@Body wiedzmin_karta wiedzmin_karta);
